...
func TestReportsCreate(t *testing.T) {
	var jsonStr = []byte(`{"type": "planning", "ref_ext": 4, "name": "Report Meeting", "date": "2022-04-14", "comment": "Nice", "nb_reel_attendees": 12, "nb_subscribe_attendees": 12, "staffs_list": "Toto Titi", "nb_hours_prepa": 2, "nb_hours": 2, "nb_staffs_vlt": 1, "nb_staffs_emp": 1, "nb_staffs_scv": 1, "taux_valorisation_vlt": 18, "taux_valorisation_emp": 18, "taux_valorisation_scv": 18, "code_public": "TST", "code_project": "ALL"}`)
