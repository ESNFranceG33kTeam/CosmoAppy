...
func setUpModel() {
	NewEvent(&Event{Name: "Voyage a Hawai", Date: "2023-04-23", Location: "Hawai", NbSpotsMax: 30, NbSpotsAvai: 30, Type: "voyage", Price: 120.42, Url: "facebook.com/voyageHawai", Actif: true})
	NewEvent(&Event{Name: "Saturday Night Fever", Date: "2023-05-23", Location: "3 rue Albert 1er, 69000 Lyon", NbSpotsMax: 30, NbSpotsAvai: 30, Type: "soiree", Price: 20, Url: "facebook.com/sturdayfever", Actif: false})
	NewAttendee(&Attendee{Id_event: 1, Id_adherent: 2, Staff: true})
	NewAttendee(&Attendee{Id_event: 1, Id_adherent: 3, Staff: false})
}

func TestNewEvent(t *testing.T) {
	NewEvent(&Event{Name: "Barathon", Date: "2023-05-12", Location: "Hotel de Ville, 69000 Lyon", NbSpotsMax: 30, NbSpotsAvai: 30, Type: "soiree", Price: 20, Url: "facebook.com/barathon", Actif: true})
}
...
func TestUpdateSpotsAvaiEvent(t *testing.T) {
	...
	if eve_2.NbSpotsAvai != 29 {
		log.Fatal("Eve_2 Spots available didn't updated !")
	}
}

func TestUpdateEvent(t *testing.T) {
	eve := Event{Id: 2, Name: "Barathon", Date: "2023-05-12", Location: "Hotel de Ville, 69000 Lyon", NbSpotsMax: 30, NbSpotsAvai: 30, Type: "soiree", Price: 0, Url: "facebook.com/barathon", Actif: true}
	UpdateEvent(&eve)
